 ...
 * 约束布局
 */
public class ConstraintStateLayout extends ConstraintLayout implements IState{
    /**
     * 属性
     */
    int textSize;
    ...
    public ConstraintStateLayout(@NonNull Context context) {
        this(context, null);
    }

    public ConstraintStateLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ConstraintStateLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
